...
export default class Todo {
    ...
    get Template() {
        return `
        <p class="${this.completed == true ? "complete" : ""}">${this.description}<input ${this.completed == true ? 'checked' : ""} type="checkbox" onclick="app.todoController.toggleTodoStatus('${this.id}')" class="mx-2">       
